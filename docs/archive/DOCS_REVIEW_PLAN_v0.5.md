# ODP v0.5 Docs Review Plan (archived)

*Status: **completed** for the README/GUIDE split and Android repo separation. Kept for history.*

This was a discussion-first plan for the documentation pass that follows the v0.5 schema and ABI lock.
