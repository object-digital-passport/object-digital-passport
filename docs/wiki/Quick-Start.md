...
- 🗺️ **Don't put exact locations on-chain** — mutable state is public forever ([privacy rules](https://github.com/object-digital-passport/object-digital-passport/blob/main/SPEC.md#privacy-of-current-state-fields-normative)).
