...
For **security vulnerabilities in the software**, use **[`SECURITY.md`](docs/SECURITY.md)** (Russian: [`web/localization/ru/SECURITY.md`](web/localization/ru/SECURITY.md)) instead of public issues.
