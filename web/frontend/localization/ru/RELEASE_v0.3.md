...
**Эталонный деплой Polygon:** в **`../../../chain/deploy/deployments/polygon.json`** есть **`walletDocumentAnchorAddress`** рядом с основным реестром — таблица **«Текущий релиз»** в [`../../../README.md`](../../../README.md) и [`README.md`](README.md#текущий-релиз). Если **`ObjectDigitalPassport`** уже задеплоен без якоря — **[`../../../chain/deploy/scripts/deploy-doc-anchor-only.js`](../../../chain/deploy/scripts/deploy-doc-anchor-only.js)** (см. **`../../../chain/deploy/README.md`**) и **`NET.docAnchor`** в **`../../../web/verify.html`**.
