...
3. **Событие kind 9** для объявлений о выпуске.
...
| 19 | Где живёт код | Спутник для всего, кроме трёх зацепок в ядре: явный `initialOwner` при минте, односторонний замок отзыва и событие kind 9. Выбор не свободный — текущий минт жёстко задаёт владельца |
