...
|                  |                                                     |
| ---------------- | --------------------------------------------------- |
| 🇬🇧 **English** | Краткий README: [../../../README.md](../../../README.md) · подробный обзор: [../../../docs/GUIDE.md](../../../docs/GUIDE.md) |
| 🇷🇺 **Русский** | Вы читаете русскую версию (этот файл).              |
| **Android companion** | [odp-android-companion](https://github.com/object-digital-passport/odp-android-companion) · интеграция: [../../../docs/ANDROID.md](../../../docs/ANDROID.md) |


**Мы рады переводам README и интерфейса на любой язык.** Добавьте файлы в `web/localization/<код-языка>/` (ориентир — структура [../ru/](../ru/)). Откройте **Pull Request** или **Issue** на GitHub — **на английском**, чтобы все участники видели одну ветку обсуждения (см. [CONTRIBUTING.md](../../../docs/CONTRIBUTING.md)).
...
**Репозиторий** (ветка `main`) — эталонная линия **v0.5**: on-chain поколение **5** при деплое Solidity из этого дерева (упакованный байт `CONTRACT_VERSION` = **5**), более богатая таксономия паспортов, изменяемые поля текущего состояния, компактный offline payload и вынесенные спутники для relations / proofs / extension mint routing — см. [docs/V0.5.md](../../../docs/V0.5.md) и справочный [SPEC](SPEC.md); нормативный текст на английском — [SPEC.md](../../../SPEC.md). **Адреса Polygon по умолчанию** в корневом README и в [chain/deploy/deployments/polygon.json](../../../chain/deploy/deployments/polygon.json) соответствуют деплою **поколения 5**, зашитому в `NET.*` статических страниц; при своём хостинге сверяйте **сеть + адрес + ABI** с вашим развёртыванием.
...
- `[../../../docs/V0.5.md](../../../docs/V0.5.md)` · исторические `[../../../docs/V0.4.md](../../../docs/V0.4.md)` / `[RELEASE_v0.4.md](RELEASE_v0.4.md)` (on-chain v0.5 + сайт; эталонные адреса Polygon — `[../../../chain/deploy/deployments/polygon.json](../../../chain/deploy/deployments/polygon.json)`)

## Как вносить вклад

- Гайд: `[CONTRIBUTING.md](../../../docs/CONTRIBUTING.md)` (оригинал EN: `[../../../docs/CONTRIBUTING.md](../../../docs/CONTRIBUTING.md)`)
- Кодекс: `[CODE_OF_CONDUCT.md](docs/CODE_OF_CONDUCT.md)` (EN: `[../../../docs/CODE_OF_CONDUCT.md](../../../docs/CODE_OF_CONDUCT.md)`)
