<p align="center">
  <img src="../../docs/images/odp-cover-ru.png" alt="Object Digital Passport — профиль создателя с QR для проверки" width="100%" />
</p>
...
**Object Digital Passport (ODP)** — простая идея: зарегистрировать физический или цифровой объект в **общедоступной записи**, чтобы позже любой мог **проверить**, что данные по-прежнему сходятся — без привязки к одной компании, подписке или «владельцу» реестра.

Разбираться в блокчейне **не обязательно**, чтобы попробовать **[живые страницы-демо](#демонстрация)**. Проверка паспорта бесплатна и не требует кошелька. Выпуск профиля и паспорта использует обычные браузерные кошельки и небольшую комиссию сети Polygon — подробности в [С чего начать](#с-чего-начать) и [Быстрый старт](#быстрый-старт-5-минут).
