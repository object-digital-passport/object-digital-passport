...
**Мы рады переводам README и интерфейса на любой язык.** Добавьте файлы в `localization/<код-языка>/` (ориентир — структура [../ru/](../ru/)). Откройте **Pull Request** или **Issue** на GitHub — **на английском**, чтобы все участники видели одну ветку обсуждения (см. [CONTRIBUTING.md](../../CONTRIBUTING.md)). Оформление правок: **[CONTRIBUTING.md](CONTRIBUTING.md)** (оригинал EN: [../../CONTRIBUTING.md](../../CONTRIBUTING.md)).
