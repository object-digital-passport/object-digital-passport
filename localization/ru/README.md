...
Глубоко разбираться в устройстве блокчейна **не обязательно**, чтобы попробовать **[демо-сайт](#демонстрация)**. Проверка паспорта бесплатна и не требует кошелька. Выпуск профиля и паспорта использует обычные браузерные кошельки и небольшую комиссию сети Polygon (часто порядка **~1 ₽** или **~$0,01** на типичную операцию — зависит от курса и загрузки сети) — подробности в [С чего начать](#с-чего-начать) и [Быстрый старт](#быстрый-старт-5-минут).
