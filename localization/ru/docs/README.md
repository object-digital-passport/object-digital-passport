...
| **[`V0.4.md`](../../docs/V0.4.md)** | **Эталонный сайт и документация (v0.4):** WalletConnect, восстановление сессии, уточнения SPEC (URI) — [`../../RELEASE_v0.4.md`](../../RELEASE_v0.4.md), [`../RELEASE_v0.4.md`](../RELEASE_v0.4.md). Эталонный on-chain по умолчанию — **v0.3**. |
