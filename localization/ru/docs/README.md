...
| **[`V0.4.md`](../../docs/V0.4.md)** | **Линия v0.4 (текущий `main`):** on-chain поколение **4**, опциональный `ODPCounterfeitConcern`, веб и SPEC — [`../../RELEASE_v0.4.md`](../../RELEASE_v0.4.md), [`../RELEASE_v0.4.md`](../RELEASE_v0.4.md). Эталонные **`NET.*`** в репозитории рассчитаны на этот деплой. |
| **[`SECURITY.md`](../SECURITY.md)** | **Модель угроз и границы доверия** для эталонной линии v0.4. EN: [`../../SECURITY.md`](../../SECURITY.md). |
